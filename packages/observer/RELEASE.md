...
## 0.1.1 candidate contract

```text
package: @hobin/observer@0.1.1
npm access/tag: public/latest
Node: >=22.19.0
Pi peer: >=0.80.10 <0.83.0
TypeBox peer: ^1.3.6
pack: exactly 43 allowlisted files; no tests or scripts
```
...
```sh
npm view @hobin/observer@0.1.1 name version dist-tags dist.integrity --json
pi install npm:@hobin/observer@0.1.1
pi list
```
