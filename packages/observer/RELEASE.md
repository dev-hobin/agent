...
## 0.1.2 candidate contract

```text
package: @hobin/observer@0.1.2
...
```sh
npm view @hobin/observer@0.1.2 name version dist-tags dist.integrity --json
pi install npm:@hobin/observer@0.1.2
pi list
```
